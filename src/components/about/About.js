            ...
            <div className='about'>
                <div className="aboutContent fontsc">
                    ...
                    <div className="aboutText">
                        ...
                        <p>bodyta隶属于棉捷（北京）网络科技有限公司，是一家专注于纺织品传感器（Textile Sensor）的技术研发、生产以及多领域产品的解决方案品牌。</p>
                        <p >棉捷（北京）网络科技有限公司是一家专注于纺织品传感器（Textile Sensor）的技术研发、生产以及多领域产品的解决方案的科技公
                        ...
                        <p >bodyta纤维传感器（bodyta Fiber Sensor）广泛应用于智能家居、智能
